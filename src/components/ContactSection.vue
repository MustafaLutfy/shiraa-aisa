  ...
  <section class="py-20 px-6 bg-bg-dark">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="text-center mb-14">
        ...
        <h2 class="font-arabic text-white text-3xl sm:text-4xl font-bold mb-3" dir="rtl">تواصل معنا</h2>
        <p class="text-text-muted text-sm max-w-lg mx-auto" dir="rtl">
          زوروا معرضنا أو تواصلوا معنا لمناقشة احتياجات مشروعكم
        </p>
      </div>
